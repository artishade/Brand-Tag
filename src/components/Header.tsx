...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-14 sm:h-16 border-b border-zinc-800 bg-zinc-950/90 backdrop-blur px-3 sm:px-5 flex items-center justify-between z-30 shrink-0 select-none">
      {/* Brand Identity */}
      <div className="flex items-center gap-2 sm:gap-3">
        <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-gradient-to-tr from-indigo-600 via-indigo-500 to-sky-400 flex items-center justify-center shadow-lg shadow-indigo-500/20 shrink-0">
          <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
        </div>
        <div>
          <div className="flex items-center gap-1.5">
            <h1 className="text-sm sm:text-base font-bold text-zinc-100 tracking-tight">BrandStudio</h1>
            <span className="text-zinc-600 font-mono text-[10px] sm:text-xs">v2.6</span>
          </div>
          <p className="text-[10px] sm:text-[11px] text-zinc-400 hidden xs:block sm:block">AI Purifier & Batch Watermark</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2.5">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 sm:px-3.5 py-1.5 text-xs font-semibold text-white bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 rounded-lg transition-colors cursor-pointer shadow-sm"
        >
          <Plus className="w-3.5 h-3.5" />
          <span className="hidden sm:inline">Add Media / ZIP</span>
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 sm:px-3.5 py-1.5 text-xs font-semibold text-white bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 disabled:opacity-40 disabled:pointer-events-none rounded-lg transition-all shadow-md shadow-indigo-600/25 cursor-pointer"
        >
          <FolderArchive className="w-3.5 h-3.5" />
          <span className="hidden sm:inline">Export Clean ZIP</span>
